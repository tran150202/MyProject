...
namespace SV20T1020598.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        //Tên biến session lưu điều khiển tìm kiếm mặt hàng khi lập đơn hàng
        ...
        /// <summary>
        /// Chuyen don hang sang trang thai da duoc duyet
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        public IActionResult Finish(int id = 0)
        {
            ...
            if (!result)
                TempData["Message"] = "Không thể ghi nhận trang thái kết thúc cho đơn hàng này";
            return RedirectToAction("Details", new { id });
        }
        /// <summary>
        /// Chuyen don hang sang trang thai bi huy
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Chuyen don hang sang trang thai bi tu choi
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="id">Mã đơn hàng</param>
        /// <param name="producId">Mã mặt hàng cần xóa</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="id">Mã đơn hàng</param>
        /// <param name="producId">Mã mặt hàng</param>
        /// <returns></returns>
        [HttpGet]
        ...
        /// Hàm trả về chuỗi khác rỗng thông báo lõi nếu đầu vào không hợp lệ
