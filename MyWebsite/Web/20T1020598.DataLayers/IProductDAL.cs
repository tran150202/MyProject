...
namespace SV20T1020598.DataLayers
{
    public interface IProductDAL
    {
        ...
        /// <param name="searchValue">Tên mặt hàng cần tìm (chuỗi rỗng nếu không tìm theo loại hàng)</param>
        /// <param name="categoryID">Mã loại hàng cần tìm (0 nếu không tìm theo nhà cung cấp)</param>
        ...
        /// <param name="supplierID">Mã nhà cung cấp cần tìm (0 nếu không tùm theo nhà cung cấp)</param>
        /// <param name="minPrice">Mức giá nhỏ nhất trong khoảng giá cần tìm</param>
        /// <param name="maxPrice">Mức giá lớn nhất trong khoảng giá cần tìm (0 nếu không hạn chế mức giá lớn nhất)</param>
        /// <returns></returns>
